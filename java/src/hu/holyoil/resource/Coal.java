...
public class Coal extends AbstractBaseResource {
    ...
    public void ReactToMine(Asteroid asteroid, IStorageCapable iStorageCapable) {
        System.out.println("I am coal " + this.toString() + " and I am being mined by " + iStorageCapable.toString() + " on " + asteroid.toString());
    }

    @Override
    public void ReactToPlace(Asteroid asteroid, IStorageCapable iStorageCapable) {
        System.out.println("I am coal " + this.toString() + " and I am being placed by " + iStorageCapable.toString() + " on " + asteroid.toString());
    }
